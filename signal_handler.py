...
def main():
    ...
    env.add_jars('file:///C:\\Users\\JayVishvakarma\\PycharmProjects\\ApacheFlink_GenAI_Trading\\libs\\flink-sql-connector-kafka-3.1.0-1.18.jar')
    ...
    env.execute('ApacheFlink GenAI Trading')
